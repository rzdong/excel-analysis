		...
		for (let i = 0; i < sheets[k]['data'].length; i++) {
			...
			for (let j = 0; j < sheets[k]['data'][i].length; j++) {
				...
				if (unit === 'NaN') {
					...
					if (sheets[k]['data'][i - 1][j] !== 'NaN' && sheets[k]['data'][i + 1][j] !== 'NaN') {
						sheets[k]['data'][i][j] = Number(((Number(sheets[k]['data'][i - 1][j]) + Number(sheets[k]['data'][i + 1][j])) / 2).toFixed(2));
					} else if (sheets[k]['data'][i - 1][j] !== 'NaN' && sheets[k]['data'][i + 2][j] !== 'NaN') {
					...
					} else if (sheets[k]['data'][i - 1][j] !== 'NaN' && sheets[k]['data'][i + 3][j] !== 'NaN') {
